...
def add_issue_info(issue, md):
    ...
    md.write(f"<a href='https://github.com/xpblog/say-something/blob/main/BACKUP/{issue.number}_{issue.title.replace(' ', '.')}.md'> {issue.title}</a>  <img src='https://img.shields.io/badge/-{time}-black?style=flat-square&logo='/> <br/>")
    #md.write("</td>")
