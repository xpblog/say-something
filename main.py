...
def add_issue_info(issue, md):
    ...
    md.write(f"<a href='https://github.com/xpblog/say-something/blob/main/BACKUP/{issue.number}_{issue.title.replace(' ', '.')}.md'> {issue.title}</a>  <a href='https://img.shields.io/badge/-{time}-green.svg'></a> <br/>")
    #md.write("</td>")
